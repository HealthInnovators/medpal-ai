...
c. Doctor consultation notes: Takes the raw transcript plus any hints or notes from the doctor and then creates a full note
d. Your conversation: Speech to text model that is transcribing 
